...
\label{rf-metrics}
Il processo di \ac{Request-Fulfillment} prevede la produzione mensile di \english{report} che illustrano il lavoro svolto durante la mensilità. All'interno di tali report sono riportate le seguenti metriche che indicano la qualità di processo e di conseguenza dei servizi offerti.
