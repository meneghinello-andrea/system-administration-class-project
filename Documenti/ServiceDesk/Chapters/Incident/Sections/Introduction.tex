...
Lo scopo principale del processo di \ac{Incident-Management} è quello di \keyword{ripristinare il funzionamento normale dei servizi il più rapidamente possibile} e \keyword{ridurre al minimo l'impatto negativo} sulle operazioni di \english{business}, garantendo cosi che i migliori livelli possibili di \keyword{qualità del servizio} e \keyword{disponibilità} siano mantenuti.
