...
Il proponente intende proporre all'amministrazione dell'\entity{} l'implementazione della funzione di \english{Service Desk}, piuttosto che la funzione di \english{Help Desk}, in quanto ha come obiettivo la gestione dei \english{servizi IT} e non dei singoli \english{software}/applicativi.

L'implementazione di questa funzione ha un investimento iniziale maggiore che però può essere ammortizzato nel tempo attraverso l'erogazione di servizi di \keyword{qualità} che faranno risparmiare tempo e denaro all'istituto.
