...
\label{im-io-input}
In Tabella \ref{im-io-input-table} sono illustrati gli \english{input} del processo e da chi sono ricevuti.
...
Gli \english{input} che esso riceve avvengono tramite quello che viene definito come \english{ticket}, che nasce generalmente con un incidente, prosegue con un problema ed infine diventa un errore. Viene manipolato da personale differente in momenti diversi, per maggiori dettagli vedere le attività di processo (Sezione REF).

I campi e gli attributi che compongono un \english{ticket} sono illustrati REF in cui valgono le seguenti definizioni:
