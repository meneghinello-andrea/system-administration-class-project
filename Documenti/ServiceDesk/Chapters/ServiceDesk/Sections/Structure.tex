...
A seguito di una supervisione dei locali ed aver valutato come sono suddivise le risorse (vedi Sezione \ref{sd-resources}) sui diversi presidi si ritiene adeguata l'implementazione di un \keyword{\english{Service Desk} centralizzato}.
...
Considerando che l'intera struttura ospedaliera è collocata all'interno del medesimo comune (seppur di grandi dimensioni), la duplicazione della funzione di \english{Service Desk} su entrambi i presidi è da sconsigliarsi in quanto i due presidi sono a pochi Km di distanza l'uno dall'altro.
