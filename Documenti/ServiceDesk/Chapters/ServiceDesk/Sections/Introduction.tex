...
Il proponente intende proporre all'amministrazione dell'\entity{} l'implementazione della funzione di \english{Service Desk}, piuttosto che la funzione di \english{Help Desk}, in quanto ha come obiettivo la gestione di \keyword{servizi IT} e non dei singoli \english{software}/applicativi come è invece soggetta a fare la funzione di \english{Help Desk}.

L'implementazione di questa funzione prevede un investimento iniziale maggiore che però può essere ammortizzato nel tempo attraverso l'erogazione di servizi di \keyword{qualità} che faranno risparmiare tempo e denaro all'istituto.
...
L'obiettivo primario del \english{Service Desk}, che si vuole implementare nell'istituto, consiste nel \keyword{ripristino dei normali livelli di servizio agli utenti, il più velocemente possibile, a seguito di incidenti}.
