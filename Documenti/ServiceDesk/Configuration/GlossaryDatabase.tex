...
\newglossaryentry{errore}
{
	name		= {errore},
	plural		= {errori},
	description = {In ambiente \ac{ITIL} viene definito errore un problema la cui soluzione è ormai nota}
}
...
\newglossaryentry{ticket}
{
	name		= {ticket},
	plural		= {tickets},
	description = {In ambito \ac{ITIL} ed in particolare nella sotto sezione del \english{framework} che contiene la funzione di \english{Service Desk} un \english{ticket} è il gergo tecnico che si riferisce ad una qualsiasi richiesta in ingresso alla funzione di \english{Service Desk}}
}
