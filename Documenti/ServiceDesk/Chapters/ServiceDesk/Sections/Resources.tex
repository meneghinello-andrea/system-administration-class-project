...
Il \english{budget} iniziale di cui l'\entity{} dispone per l'intero appalto è pari a \num{1500000} \euro{}. In piccola parte verrà utilizzato per l'implementazione della funzione di \english{Service Desk} e dei relativi processi di \acf{Incident-Managment}, \acf{Event-Management} e \acf{Request-Fulfillment}.

Il costo totale per l'implementazione ammonta \num{70922.4} \euro{} cosi suddivisi:
...
I seguenti costi, riportati in Tabella \ref{sd-resources-budget-table}, si riferiscono al primo anno di attività del \english{Service Desk}, mentre per gli anni successivi l'unica voce di costo che rimarrà è \attribute{licenza}.
