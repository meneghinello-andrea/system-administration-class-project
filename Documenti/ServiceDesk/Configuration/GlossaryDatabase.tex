...
\newglossaryentry{polling}
{
	name		= {polling},
	plural		= {polling},
	description = {In questa realtà con il termine \english{polling} si intende una verifica ciclica e periodica di alcuni, o tutti, i \ac{Configuration-Item} presenti al fine di determinare il loro stato di attività}
}
