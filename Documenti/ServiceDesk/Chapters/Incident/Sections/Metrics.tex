...
\label{im-metrics}
Il processo di \ac{Incident-Management} prevede la produzione mensile di \english{report} che illustrano il lavoro svolto durante la mensilità. All'interno di tali report sono riportate alcune metriche che indicano la qualità di processo e di conseguenza dei servizi offerti.
