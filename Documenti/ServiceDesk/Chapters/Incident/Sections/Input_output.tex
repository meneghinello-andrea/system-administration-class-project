...
Gli \english{input} che esso riceve avvengono tramite \english{ticket}, che nasce generalmente con un incidente, prosegue con un problema ed infine diventa un errore.

Il \english{ticket} viene manipolato da personale differente in momenti diversi, per maggiori dettagli vedere le attività di processo (Sezione \ref{im-flow}).
...
\hline
Stato & Stato in cui si trova il \english{ticket}. (Vedi Immagine \ref{im-flow-life-cycle-img}). & \attribute{lista}\\
\hline
...
\hline
Tipo & Specifica la tipologia di \english{ticket}. (\attribute{richiesta di servizio - incidente}) & \attribute{lista}\\
\hline
Categoria & Specifica la categoria presso cui si colloca il \english{ticket}. (vedi Sezione \ref{im-management-classification} per maggiori dettagli). & \attribute{lista}\\
\hline
...
Il \english{software} propone una visione ridotta del \english{ticket} in cui si vedrà la cronistoria. I campi visualizzati sono elencati in Tabella \ref{im-io-input-ticket-history-table}.
...
\hline
\endhead
Notifiche agli utenti quando il \english{ticket} cambia di stato. & Utenti\\
\hline
\end{longtable}
\end{center}